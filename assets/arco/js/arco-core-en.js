...
(() => {
  ...
  const readers = {
    r1: "The portfolio displays artifacts. The arc exposes the tension that generates them: the same question, asked at three moments. From execution to direction, from direction to architecture — not three things, but a path learning how to read itself."
...
(() => {
  ...
  const REGIMES = {
    lastro: { nome: "Documentary trace", campos: ["SOURCE", "COUNT", "POPULATION", "TIMEFRAME", "SEE IN"] },
    derivacao: { nome: "Derived trace", campos: ["DERIVED FROM", "COUNT", "POPULATION", "TIMEFRAME", "SEE IN"] }
  };
