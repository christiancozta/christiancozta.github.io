...
(() => {
  ...
  const coreUrl = new URL("arco-core-en.js?v=20260922-en-v1", src);
  ...
  core.onload = () => {
    ...
    mobile.async = false;
    mobile.onerror = () => console.error("ARCO: failed to load mobile coordination.");
    document.head.appendChild(mobile);
  };
  core.onerror = () => console.error("ARCO: failed to load the local core.");
  ...
  function installDesktopHeroController(){
    ...
    const stationMeta = {
      ...
      "3": {
        ...
        detail:"structured through a legal operations methodology built for high-volume environments."
      },
      "2": {
    ...
    stats.forEach(stat => {
      ...
      if (meta.tag){
        ...
        tag.setAttribute("aria-label", `Source: ${meta.tag}`);
